...
func (v *VariableStatement) GetPosition() *scanner.Position {
	return v.beginPos
}
...
func (v *VariableDecl) GetPosition() *scanner.Position {
	return v.Decl.beginPos
}
func (v *VariableDecl) GetTheType() IType {
	return v.TheType
}
func (v *VariableDecl) IsLeftValue() bool {
	return v.isLeftValue
}
...
func (a *AstDumper) VisitVariableDecl(variableDecl *VariableDecl, prefix any) any {
	...
	if variableDecl.Decl.AstNode.isErrorNode {
		fmt.Print(" **EL** ")
	}
	fmt.Println()
